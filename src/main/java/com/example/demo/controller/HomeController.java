...
//				Generate URL
		...
		public String showResetPassword(@RequestParam String token,HttpSession session,Model m) {
			...
			if(userByToken==null) {
				m.addAttribute("msg", "Your link in invalid or expired !!");
				return "message";
			}
		...
		@GetMapping("/search")
		public String searchProduct(@RequestParam String ch,Model m,@RequestParam(name = "pageNo", defaultValue = "0") Integer pageNo,
